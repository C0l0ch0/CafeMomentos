(function($){
	...
	$(document).ready(function() {
		...
		$('.slideshow').backstretch([
			location.origin+'/CafeMomentos/app/webroot/images/home-1.jpg',
			location.origin+'/CafeMomentos/app/webroot/images/home-2.jpg',
			location.origin+'/CafeMomentos/app/webroot/images/home-3.jpg'
		...
		if ($videoBackground.length > 0) {
			...
			BV.init();
			BV.show(
				{ type: 'video/mp4',   src: location.origin+'/CafeMomentos/app/webroot/video/video.mp4', ambient:true },
				{ type: 'video/webm',  src: location.origin+'/CafeMomentos/app/webroot/video/video.webm', ambient:true },
				{ type: 'video/ogg',   src: location.origin+'/CafeMomentos/app/webroot/video/video.ogv', ambient:true }
			);
		}
		...
		$('#subscription-form').find('input').jqBootstrapValidation({
			...
			submitSuccess: function($form, event) {
				...
				$.ajax({
					type: 'POST',
					url: location.origin+'/CafeMomentos/app/webroot/php/subscribe.php',
					dataType: 'json',
					data: {
						name: name,
						surname: surname,
		...
		$('#booking-form').find('input,textarea').jqBootstrapValidation({
			...
			submitSuccess: function($form, event) {
				...
				$.ajax({
					type: 'POST',
					url: location.origin+'/CafeMomentos/app/webroot/php/booking.php',
					dataType: 'json',
					data: {
						name: name,
						phone: phone,
		...
		$('#contact-form').find('input,textarea').jqBootstrapValidation({
			...
			submitSuccess: function($form, event) {
				...
				$.ajax({
					type: 'POST',
					url: location.origin+'/CafeMomentos/app/webroot/php/contact.php',
					dataType: 'json',
					data: {
						name: name,
						email: email,
		...
		if ($mapis.length > 0) {
			...
			var image = new google.maps.MarkerImage(location.origin+'/CafeMomentos/app/webroot/images/map-icon.png',
